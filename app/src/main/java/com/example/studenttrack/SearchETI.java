...
public class SearchETI extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_eti);
    ...
    private void displaydata() {
        ...
        if (cursor.getCount() == 0) {
            Toast.makeText(SearchETI.this, "No Entry Exists", Toast.LENGTH_SHORT).show();
        } else {
