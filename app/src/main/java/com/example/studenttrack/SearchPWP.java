...
public class SearchPWP extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_search_pwp);
    ...
    private void displaydata() {
        ...
        if (cursor.getCount() == 0) {
            Toast.makeText(SearchPWP.this, "No Entry Exists", Toast.LENGTH_SHORT).show();
        } else {
