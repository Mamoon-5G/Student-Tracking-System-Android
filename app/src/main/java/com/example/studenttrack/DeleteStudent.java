...
public class DeleteStudent extends AppCompatActivity {
        ...
        viewStudent.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (!selectedStudentId.isEmpty()) {
                    Intent i = new Intent(DeleteStudent.this, DeleteConfirmStudent.class);
                    i.putExtra("StudentID", selectedStudentId);
                    startActivity(i);
                } else {
                    Toast.makeText(DeleteStudent.this, "Please select a student ID", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void displaydata() {
        ...
        if (cursor.getCount() == 0) {
            Toast.makeText(DeleteStudent.this, "No Entry Exists", Toast.LENGTH_SHORT).show();
        } else {
